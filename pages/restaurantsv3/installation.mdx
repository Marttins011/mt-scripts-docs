...
<p>Everything else in the script will be automatically configured: framework, sql, jobs, etc.</p>
<p>If you need help with anything extra, please open ticket in our discord.</p>